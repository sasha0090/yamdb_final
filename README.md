...
## Описание проекта  
Собранный [проект Yamdb_API](https://github.com/sasha0090/Yamdb_API) в docker-compose и размещен на [Doker Hub](https://hub.docker.com/r/sasha0090/yamdb_last).
...
Проект доступен по адресу: ____
